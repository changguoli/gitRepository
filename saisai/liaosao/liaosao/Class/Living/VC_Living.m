...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    News_Cell *cell = [[News_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@""];
    Mine_model *model ;
...
- (NSArray *)setupUITableViewRowActionArr {
    UITableViewRowAction *moneyTableViewAction = [UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleNormal title:@"置顶" handler:^(UITableViewRowAction * _Nonnull action, NSIndexPath * _Nonnull indexPath) {
        //续费
    }];
    
    
    UITableViewRowAction *picTableViewAction = [UITableViewRowAction rowActionWithStyle:UITableViewRowActionStyleDefault title:@"删除" handler:^(UITableViewRowAction * _Nonnull action, NSIndexPath * _Nonnull indexPath) {
        //进入相册
