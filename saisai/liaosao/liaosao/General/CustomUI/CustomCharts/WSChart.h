 ...
 *  @para start：Draw Starting Point
 *  @para end：Draw Ending Point
 *  @para isDotted：Is the dotted line
 *  @para color：Line color
 */
 ...
 *  @para point：Draw position
 *  @para color：TextColor
 *  @para fontSize：Text font size
 */
 ...
 *  @para redius：Circle redius
 *  @para p:Draw position
 *
 */
 ...
 *  @para maxSize：Maximum range of text
 *  @para textFont：Text font
 *  @para aimString:Text that needs to be measured
 */
