...
+ (id)plusButton {
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"news"];
...
- (void)clickPublish {
    ...
    Base_RTRootNavigationController *BAVC = [[Base_RTRootNavigationController alloc] init];
    [BAVC presentViewController:vcliving animated:YES completion:^{
